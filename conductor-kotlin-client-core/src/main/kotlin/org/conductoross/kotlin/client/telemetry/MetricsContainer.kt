 ...
 */
package org.conductoross.kotlin.client.telemetry
...
object MetricsContainer {
    ...
    init {
        ...
        val metricScope = CoroutineScope(metricDispatcher + SupervisorJob())
        metricScope.launch {
    ...
    private fun getTags(additionalTags: List<String>): List<Tag> {
        ...
        for (i in additionalTags.indices step 2) {
            tagList.add(BasicTag(additionalTags[i], additionalTags[i + 1]))
        }
        return tagList
    }
}