...
interface Worker {
    ...
    val pollingInterval: Duration
         ...
         *
         * @return interval at which the server should be polled for worker tasks.
         */
        get() = Duration.parse(PropertyFactory.getString(taskDefName, "pollInterval") ?: "1s")

    val leaseExtendEnabled: Boolean
        get() = PropertyFactory.getBoolean(taskDefName, "leaseExtendEnabled") ?: false

    val batchPollTimeout: Duration
        get() = Duration.parse(PropertyFactory.getString(taskDefName, "batchPollTimeoutInMS") ?: "1s")
